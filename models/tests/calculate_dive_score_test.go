...
// TestCalculateDiveScore tests the CalculateDiveScore function
func TestCalculateDiveScore(t *testing.T) {
	// Setup
	LoadEnv()
	db.Connect()
	...
	for _, tc := range testCases {
		...
		// Test CalculateDiveScore
		_, err = models.CalculateDiveScore(uint64(dive.ID))
