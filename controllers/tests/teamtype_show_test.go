...
// TestTeamTypeShow is a controller for testing the team_type show page
func TestTeamTypeShow(t *testing.T) {
	...
	r.GET("/admin/teamtypes/:id", controllers.TeamTypeShow)

	// Create a team_type
	tt1, _ := models.TeamTypeCreate("Teat Team Type")

	// Create a get request to /admin/teamtypes/:id
	req, err := http.NewRequest("GET", "/admin/teamtypes/"+helpers.UintToString(tt1.ID), nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	// Check if the test_type is in the response
