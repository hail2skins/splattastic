...
// TestTeamTypeNew is a controller for creating a new team_type
func TestTeamTypeNew(t *testing.T) {
	// Setup
	LoadEnv()
	db.Connect()
	...
	r.GET("/admin/teamtypes/new", controllers.TeamTypeNew)

	// Create a new request
	req, err := http.NewRequest("GET", "/admin/teamtypes/new", nil)
	if err != nil {
		t.Fatal(err)
	}
